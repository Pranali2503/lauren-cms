...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    authors: Schema.Attribute.Relation<'oneToMany', 'api::subtopic.subtopic'>;
...
export interface ApiLearningCategoryLearningCategory
  ...
  attributes: {
    ...
    isBaseTemplate: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiLearningModuleLearningModule
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    weekRange: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiLearningTopicLearningTopic
  extends Struct.CollectionTypeSchema {
  collectionName: 'learning_topics';
  info: {
    displayName: 'Learning Topics';
    pluralName: 'learning-topics';
    singularName: 'learning-topic';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    learningCategory: Schema.Attribute.Relation<
      'manyToOne',
      'api::learning-category.learning-category'
    >;
    locale: Schema.Attribute.String;
...
export interface ApiOnboardingWalkthroughOnboardingWalkthrough
  ...
  attributes: {
    buttonLabels: Schema.Attribute.Component<
